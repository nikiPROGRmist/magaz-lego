...
export const Card = ({ image, product, title, price, onPlus, obj }) => {
  ...
  return (
    <div className={style.card__item}>
      ...
      <div className={style.text__item}>
        <div onClick={onBtnCard} className={style.cart__btn}>
          {onClickBtn ? (
            <div className={style.cart__grin}>
              <svg
                width="12"
                height="11"
                viewBox="0 0 12 11"
            ...
            <div className={style.card__while}>
              <svg
