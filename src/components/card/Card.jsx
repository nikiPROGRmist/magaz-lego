...
export const Card = ({
  ...
  const onFavoriteCard = () => {
    setOnClickFavorite(!onClickFavorite);
    onFavorite({ id, image, title, price, product });
  };
  return (
    <div className={style.card__item}>
      <div className={style.img__item}>
        <img src={image} alt="" />
        <div onClick={onFavoriteCard} className="onClick">
          {onClickFavorite ? (
            <div className={style.favorite__pink}>
              <svg
                width="15"
                height="15"
                viewBox="0 0 15 14"
