  ...
  return (
    <footer className={style.footer}>
        ...
        <div className={style.footer__right}>
          <div className={style.footer__item}>
            ...
            <div className={style.link__item}>
              <a href="/">О LEGO Group</a>
            </div>
            <div className={style.link__item}>
              <a href="/">Новости LEGO®</a>
            </div>
            <div className={style.link__item}>
              <a href="/">Устойчивое развитие</a>
            </div>
            <div className={style.link__item}>
              <a href="/">Заявление о прозрачности канала</a>
            </div>
            <div className={style.link__item}>
              <a href="/">Сертификация продукции LEGO</a>
            </div>
          </div>
          <div className={style.footer__item}>
            ...
            <div className={style.link__item}>
              <a href="/">Найти инструкцию по сборке</a>
            </div>
            <div className={style.link__item}>
              <a href="/">Запасные детали</a>
            </div>
            <div className={style.link__item}>
              <a href="/">Отзыв товаров</a>
            </div>
          </div>
          <div className={style.footer__item}>
            <div className={style.title}>Атракционы</div>
            <div className={style.link__item}>
              <a href="/">LEGO® House</a>
            </div>
            <div className={style.link__item}>
      ...
      <div className={style.text}>
        LEGO System A/S, DK-7190 Billund, Denmark. Совершать покупки онлайн могут только лица старше
        18 лет. LEGO, логотип LEGO, Минифигурка (Minifigure), DUPLO, LEGENDS OF CHIMA, NINJAGO,
        BIONICLE, MINDSTORMS и MIXELS являются товарными знаками и объектами авторского права
        корпорации LEGO Group. ©2022 The LEGO Group. Все права защищены. Используя этот сайт, вы
        выражаете свое согласие с Условиями использования.
      </div>
    </footer>
  );
};
