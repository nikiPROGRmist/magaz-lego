...
export const Favorite = ({ favoriteCard = [], onClickFavorite }) => {
  return (
      ...
      {favoriteCard.map((obj) => {
        return (
          <div className={style.card__item}>
            ...
            <div className={style.title}>{obj.product}</div>

            <div className={style.text}>{obj.title}</div>
            <div className={style.text__item}></div>

            <div className={style.price__title}>Цена:</div>
            <div className={style.price}>{obj.price}</div>
          </div>
        );
      })}
    </div>
